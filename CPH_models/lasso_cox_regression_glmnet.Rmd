...
oncoth1_selected_vars <- oncoth1_data %>%
...
stopifnot(!anyNA(oncoth1_selected_vars))
```
...
```{r}
oncoth1_transf <- process_data(oncoth1_selected_vars, cols2select = cols2select)
```


```{r}
Y0 <- with(oncoth1_selected_vars, Surv(time, death))
Y0
```
