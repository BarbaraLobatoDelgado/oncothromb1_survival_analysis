...
write.csv(x = train_ids, file = "../partition_indices/train_ids.csv", row.names = FALSE, col.names = FALSE)
write.csv(x = test_ids, file = "../partition_indices/test_ids.csv", row.names = FALSE, col.names = FALSE)
```
