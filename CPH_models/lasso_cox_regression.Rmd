...
# Partition data
training_set <- covariates_scaled[train_rows,]
test_set <- covariates_scaled[test_rows,]

# Partition response
y_training <- response[train_rows,]
y_test <- response[test_rows,]
...
stopifnot(length(y_training) + length(y_test) == length(response))
```
