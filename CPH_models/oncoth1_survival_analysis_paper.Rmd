...
write.csv(x = train_ids, file = "../partition_indices/stepwise_train_ids.csv", row.names = FALSE)
write.csv(x = test_ids, file = "../partition_indices/stepwise_test_ids.csv", row.names = FALSE)
```
