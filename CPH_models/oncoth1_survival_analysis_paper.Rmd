...
```{r}
# load("/mnt/ir-bioinf02/home/blobato/oncothromb01/data/processed/oncoth1_an9elproject_versions/oncoth1.RData_0.0.8030")
# oncoth1 <- obj
# rm(obj)
```
...
# Load DB
# tryCatch({
#   oncoth1 <- get_project("oncothr1", version = "0.0.8023") # "0.0.8005"
#   },
#   warning = function(w) {
#     "Cannot open an9elobject project"
#     },
#   finally = {
#     load("/mnt/ir-bioinf02/home/blobato/oncothromb01/data/processed/oncoth1_an9elproject_versions/oncoth1.RData_0.0.8005") # 0.0.8005
#     oncoth1 <- obj
#     rm(obj)
#   }
# )
...
oncoth1_data %<>%
  mutate(tobacco_use = case_when(
    tobacco_use == "Never has smoked" ~ "Never", 
    tobacco_use == "Former smoker" ~ "Former/current",
    tobacco_use == "Active smoker" ~ "Former/current"), 
    .after = tobacco_use)
...
# oncoth1_data %<>%
#   mutate(tu_1st_vte_all_from_cancer_diagnosis_days_corrected = as.Date(date_1st_vte_all) - as.Date(date_cancer_dx))
```
...
write.csv(x = train_ids, file = "../partition_indices/stepwise_train_ids.csv", row.names = FALSE, col.names = FALSE)
write.csv(x = test_ids, file = "../partition_indices/stepwise_test_ids.csv", row.names = FALSE, col.names = FALSE)
```
