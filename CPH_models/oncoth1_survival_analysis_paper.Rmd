...
oncoth1_correlations_vars = survival_vte_tmerge_dummies %>%
  ...
  select(
    ...
    grade_histological_differentiation_imp_Moderately differentiated, grade_histological_differentiation_imp_Poorly differentiated, n_metastases_1, n_metastases_2, n_metastases_3, n_metastases_4, n_metastases_5, n_metastases_grouped_1, n_metastases_grouped_2+, metastasis_adrenal_glands_Yes, metastasis_bones_Yes, metastasis_brain_Yes, metastasis_liver_Yes, metastasis_lung_Yes, metastasis_lymph_nodes_Yes, metastasis_peritoneum_Yes, metastasis_pleura_Yes, metastasis_skin_Yes, metastasis_soft_tissues_Yes, other_metastases_Yes, catheter_device_imp_Yes, venous_insufficiency_imp_Yes, n_comorbidities_1, n_comorbidities_2+, family_background_vte_Yes, family_background_vte_n_1, family_background_vte_n_2, family_background_vte_all_relatives_Father, family_background_vte_all_relatives_Mother, family_background_vte_all_relatives_Siblings, family_background_vte_all_relatives_Offspring, family_background_vte_all_relatives_Others, family_background_vte_all_relatives_Two relatives, family_background_VTE_father_Yes, family_background_VTE_mother_Yes, family_background_VTE_siblings_Yes, family_background_VTE_offspring_Yes, family_background_VTE_other_relatives_Yes, previous_vte_Yes, previous_ate_Yes, n_previous_ate_1, n_previous_ate_2, n_previous_ate_3, previous_ate_type_CVA, previous_ate_type_Myocardial infarction, previous_ate_type_PAD, previous_ate_type_TIA, previous_ate_type_Other, previous_ate_type_Two or more, cva_ate_Yes, myocardial_infarction_ate_Yes, pad_ate_Yes, tia_ate_Yes, other_thromb_ate_Yes, anticoag_tx_vte_Yes, anticoag_tx_vte_NA, anticoag_tx_vte_drugs_Vit K antagonists, anticoag_tx_vte_drugs_NA, anticoag_tx_cardiopathy_Yes, anticoag_tx_other_causes_Yes, anticoag_tx_reason_Others, anticoag_tx_reason_VTE, anticoag_tx_reason_NA, anticoag_tx_apixaban_Yes, anticoag_tx_dabigatran_Yes, anticoag_tx_lmwh_Yes, anticoag_tx_lmwh_NA, anticoag_tx_lmwh_dosage_Therapeutic, anticoag_tx_lmwh_dosage_NA, anticoag_tx_vit_k_antag_Yes, anticoag_tx_other_drugs_Yes, anticoag_tx_currently_Yes, n_antiaggreg_tx_1, n_antiaggreg_tx_2, antiaggreg_tx_reason_CVA, antiaggreg_tx_reason_Cardiopathy, antiaggreg_tx_reason_Others, antiaggreg_tx_reason_Two ATE types, antiaggreg_tx_cardiopathy_Yes, antiaggreg_tx_cva_Yes, antiaggreg_tx_other_causes_Yes, antiaggreg_tx_currently_Yes, vte_recurrence_No VTE recurrence, vte_recurrence_VTE recurrence) %>%
  cor(.)
