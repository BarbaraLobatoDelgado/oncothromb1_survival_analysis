...
# Men
man_td_survival_analysis = td_survival_analysis %>%
  filter(gender == "Man") 
...
# Women
woman_td_survival_analysis = td_survival_analysis %>%
  filter(gender == "Woman") 
...
n_man = as.numeric(sum(oncoth1[["data"]]$gender == "Man"))
n_woman = as.numeric(sum(oncoth1[["data"]]$gender == "Woman"))
...
ggsurvplot_facet(
    survival_clinical_factors_fit1,
    td_survival_analysis,
    censor = FALSE,
    xscale = 30, 
    break.x.by = 60,
    conf.int = TRUE,
...
summary(survfit(
  ...
  data = td_survival_analysis_months), times = 18)
```
