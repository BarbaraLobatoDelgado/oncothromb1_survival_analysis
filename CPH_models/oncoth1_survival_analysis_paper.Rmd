...
```{r}
# Load DB
oncoth1 = get_project("oncothr1", version = "0.0.8003") # 0.0.8001
```
...
comorbidities_cols_index = which(colnames(oncoth1_data) %in% c(
  "diabetes_mellitus", 
  "dyslipidemia", 
...
oncoth1_data$n_comorbidities <- rowSums(oncoth1_data[, comorbidities_cols_index] == "Yes")
