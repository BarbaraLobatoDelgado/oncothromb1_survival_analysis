...
```{r}
inc_symp_km_fit_vte = survfit(Surv(
  time = tstart, 
  time2 = tstop, 
  event = death) ~ 
    first_vte_inc_symp + 
...
```{r}
#jpeg("./graphs/time_dependent_covariate_analysis/vte_td_surv_analysis_KM_curve.jpeg", width = 6.5, height = 4, units = 'in', res = 700)
inc_symp_km_plot_vte = 
  ggsurvplot(
    fit = inc_symp_km_fit_vte,
    data = survival_vte_tmerge_inc_sympt,
    xscale = 30,
    break.time.by = 60,
    censor = FALSE, 
...
# Add p-value
inc_symp_km_plot_vte$plot = inc_symp_km_plot_vte$plot + 
  annotate(
    geom = "text", 
    x = 26,
    y = 0.3,
