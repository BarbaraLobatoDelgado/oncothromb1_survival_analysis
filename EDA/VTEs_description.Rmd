...
ggplot(
  ...
  geom_vline(
    ...
    color = "grey",
    size = 0.5) +
  # Manually add brackets and p-values
  geom_segment(
    data = proportion_test_VTE_sympt_cancer_type,
    aes(x = as.numeric(as.factor(primary_tumor_simplified)) - 0.3, 
        xend = as.numeric(as.factor(primary_tumor_simplified)) + 0.3, 
        y = y_position, 
        yend = y_position),
    color = "black",
    size = 0.5
  ...
  geom_text(
    data = proportion_test_VTE_sympt_cancer_type,
    aes(x = as.numeric(as.factor(primary_tumor_simplified)), 
        y = y_position + 6, 
        label = paste0("p = ", format.pval(p_value))),
    size = 3,
    color = "black"
  ) +
  theme_bw() +
