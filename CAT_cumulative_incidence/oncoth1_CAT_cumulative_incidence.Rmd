...
get_cumulative_incidence = function(fit_summary, event_code = 1){
  ...
  print(paste("12-month CAT cumulative incidence for ONCOTHROMB1 cohort is", round(1 - cuminc_12month_stats$surv, digits = 4), "(CI", round(1 - cuminc_12month_stats$upper, digits = 4), "-", round(1 - cuminc_12month_stats$lower, digits = 4), ")"))
  ...
  print(paste("18-month CAT cumulative incidence for ONCOTHROMB1 cohort is", round(1 - cuminc_18month_stats$surv, digits = 4), "(CI", round(1 - cuminc_18month_stats$upper, digits = 4), "-", round(1 - cuminc_18month_stats$lower, digits = 4), ")"))
}
```
