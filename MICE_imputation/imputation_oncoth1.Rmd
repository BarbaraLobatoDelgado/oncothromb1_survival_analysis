...
The imputation of missing values in clinical variables will be done using the MICE method. 
...
percentage_missing_values_per_var = as.data.frame(apply(oncoth1_data, 2, proportion_missing_values))

# Show only variables with missing values
percentage_missing_values_per_var = percentage_missing_values_per_var[percentage_missing_values_per_var != 0]

percentage_missing_values_per_var
```
